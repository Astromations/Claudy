...
2. Open the **Settings** panel (`Ctrl+,`) and add `'Anthropic Mono Web'` to **Editor: Font Family**. eg. (`'Anthropic Mono Web', Consolas, 'Courier New', monospace`)
3. Alternatively **Set it in VSCode settings** — add this to your `settings.json`:

```jsonc
{
  "editor.fontFamily": "'Anthropic Mono Web', Consolas, 'Courier New', monospace",
  "editor.fontSize": 14,
